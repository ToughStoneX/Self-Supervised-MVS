...
# def filter_depth(testpath, out_folder, plyfilename, scan_id):
#     # the pair file
#     pair_file = os.path.join(testpath, "Cameras", "pair.txt")
...
#             os.path.join(testpath, 'Cameras/{:0>8}_cam.txt'.format(ref_view)))
#         # load the reference image
#         ref_img = read_img(os.path.join(testpath, 'Rectified/scan{}_train/rect_{:03}_3_r5000.png'.format(scan_id, ref_view+1)))
#         # ref_img = read_img(os.path.join(scan_folder, 'Rectified/{:0>8}.jpg'.format(ref_view)))
#         # load the estimated depth of the reference view
#         ref_depth_est = read_pfm(os.path.join(out_folder, 'depth_est/{:0>8}.pfm'.format(ref_view)))[0]
#         # load the photometric mask of the reference view
#         confidence = read_pfm(os.path.join(out_folder, 'confidence/{:0>8}.pfm'.format(ref_view)))[0]
#         photo_mask = confidence > 0.2
#
...
#                 os.path.join(testpath, 'Cameras/{:0>8}_cam.txt'.format(src_view)))
...
#
#         print("processing {}, ref-view{:0>2}, photo/geo/final-mask:{}/{}/{}".format(scan_id, ref_view,
#                                                                                     photo_mask.mean(),
...
#         # print('ref_img: {} valid_points: {}'.format(ref_img.shape, valid_points.shape))
...
if __name__ == '__main__':
    ...
    for scan in scans:
        ...
        # filter_depth(args.testpath, out_folder, os.path.join(args.outdir, 'mvsnet{:0>3}_l3.ply'.format(scan_id)), scan_id)
